            ...
            <div className="grid grid-cols-2 gap-3">
                ...
                <div className="relative">
                    <select
                        ...
                        className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3.5 pl-16 text-white appearance-none cursor-pointer hover:bg-white/10 transition-colors focus:outline-none focus:ring-2 focus:ring-#3B82F6"
                    >
                        {tokens.map((token) => (
