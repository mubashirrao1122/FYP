...
const heroStats: { label: string; value: string }[] = [
  { label: "Total volume", value: "$96.2M" },
...
export function GlowyWavesHero({ onLaunchApp }: GlowyWavesHeroProps) {
  ...
  return (
    <section
      ...
      role="region"
      aria-label="SolRush hero section"
    >
      <canvas
        ref={canvasRef}
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-col items-center px-6 py-24 text-center md:px-8 lg:px-12">
        ...
        >
          ...
          >
            Trade digital assets with{" "}
            <span className="bg-gradient-to-r from-[#3B82F6] via-[#60A5FA] to-foreground/80 bg-clip-text text-transparent">
              institutional speed
            </span>
          </motion.h1>
          ...
          >
            A calm, precise trading experience built on transparent liquidity.
            Real-time execution, predictable fees, and non-custodial control
          ...
          >
            <Button
              size="lg"
              onClick={onLaunchApp}
              className="group gap-2 rounded-full bg-[#3B82F6] hover:bg-[#2563EB] px-8 text-base uppercase tracking-[0.2em] text-white shadow-[0_0_20px_rgba(59,130,246,0.35)] hover:shadow-[0_0_30px_rgba(59,130,246,0.55)] transition-all"
            >
              Launch App
              <ArrowRight
